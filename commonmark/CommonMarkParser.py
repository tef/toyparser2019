class Parser:
    ...
    def parse_setext_heading(self, buf, offset_0, buf_eof, column_0, indent_column_0, prefix_0, children_0, partial_tab_offset_0, partial_tab_width_0):
        while True: # note: return at end of loop
            ...
            while True: # start capture
                ...
                indent_column_0 = (column_0, indent_column_0)
                while True:
                    offset_1, column_0, indent_column_0, partial_tab_offset_0, partial_tab_width_0 = self.parse_strict_inline_para(buf, offset_1, buf_eof, column_0, indent_column_0, prefix_0, children_1, partial_tab_offset_0, partial_tab_width_0)
                    if offset_1 == -1: break
                                    ...
                                    while True: # case
                                        ...
                                        for indent, dedent in prefix_0:
                                            ...
                                            if offset_5 == -1:
                                                ...
                                                _children, _prefix = [], []
                                                offset_5 = offset_4
                                                offset_5, _column, _indent_column, _partial_tab_offset, _partial_tab_width = dedent(buf, offset_5, buf_eof, column_2, indent_column_2, _prefix, _children, partial_tab_offset_2, partial_tab_width_2)
                                                if offset_5 != -1:
                                                    offset_4 = -1
                                                    break
                                                else:
                                        ...
                                        while True: # start reject
                                            ...
                                            while True: # start choice
                                                ...
                                                while True: # case
                                                    count_2 = 0
                                                    while offset_6 < buf_eof and count_2 < 3:
                                                        chr = buf[offset_6]
                                                        if chr in ' \t':
                                                            if chr == '\t':
                                                                if offset_6 == partial_tab_offset_4 and partial_tab_width_4 > 0:
    ...
    def parse_strict_inline_para(self, buf, offset_0, buf_eof, column_0, indent_column_0, prefix_0, children_0, partial_tab_offset_0, partial_tab_width_0):
        while True: # note: return at end of loop
