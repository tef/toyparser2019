        ...
        def parse_backtick_code_block(self, buf, offset_0, buf_eof, column_0, indent_column_0, prefix_0, children_0, partial_tab_offset_0, partial_tab_width_0):
            while True: # note: return at end of loop
                    ...
                    while True:
                        ...
                        while True:
                                        ...
                                        while True: # start choice
                                            ...
                                            while True: # case
                                                ...
                                                if offset_6 == -1:
                                                    offset_5 = -1
                                                    break
                                                value_4 = self.Node('text', offset_5, offset_6, children_6, None)
                            ...
                            if offset_3 == -1:
                                offset_2 = -1
                                break
                            value_5 = self.Node('text', offset_2, offset_3, children_3, None)
                ...
                if offset_1 == -1:
                    offset_0 = -1
                    break
                value_6 = self.Node('fenced_code', offset_0, offset_1, children_1, None)
