class Parser:
    ...
    def parse_rson_value(self, buf, offset_0, buf_eof, line_start_0, indent_end_0, prefix_0, children_0):
        while True: # note: return at end of loop
    ...
    def parse_rson_literal(self, buf, offset_0, buf_eof, line_start_0, indent_end_0, prefix_0, children_0):
        while True: # note: return at end of loop
            while True: # start choice
                offset_1 = offset_0
                line_start_1 = line_start_0
    ...
    def parse_rson_string(self, buf, offset_0, buf_eof, line_start_0, indent_end_0, prefix_0, children_0):
        while True: # note: return at end of loop
            while True: # start choice
                offset_1 = offset_0
                line_start_1 = line_start_0
    ...
    def parse_rson_list(self, buf, offset_0, buf_eof, line_start_0, indent_end_0, prefix_0, children_0):
        while True: # note: return at end of loop
    ...
    def parse_rson_object(self, buf, offset_0, buf_eof, line_start_0, indent_end_0, prefix_0, children_0):
        while True: # note: return at end of loop
            if buf[offset_0:offset_0+1] == '{':
                offset_0 += 1
            else:
