        ...
        def parse_true_literal(self, buf, buf_start, buf_eof, offset_0, column_0, indent_column_0, prefix_0, children_0, partial_tab_offset_0, partial_tab_width_0):
            while True: # note: return at end of loop
                ...
                if offset_1 == -1:
                    offset_0 = -1
                    break
                value_0 = self.Node('bool', offset_0, offset_1, column_0, column_1, children_1, None)
        ...
        def parse_null_literal(self, buf, buf_start, buf_eof, offset_0, column_0, indent_column_0, prefix_0, children_0, partial_tab_offset_0, partial_tab_width_0):
            while True: # note: return at end of loop
                ...
                if offset_1 == -1:
                    offset_0 = -1
                    break
                value_0 = self.Node('null', offset_0, offset_1, column_0, column_1, children_1, None)
                children_0.append(value_0)
                offset_0 = offset_1
                column_0 = column_1
                ...
                while True: # start choice
                    ...
                    while True: # case
                        ...
                        if offset_2 == -1:
                            offset_1 = -1
                            break
                        value_0 = self.Node('identifier', offset_1, offset_2, column_1, column_2, children_2, None)
        ...
        def parse_number_literal(self, buf, buf_start, buf_eof, offset_0, column_0, indent_column_0, prefix_0, children_0, partial_tab_offset_0, partial_tab_width_0):
            while True: # note: return at end of loop
                ...
                if offset_1 == -1:
                    offset_0 = -1
                    break
                value_0 = self.Node('number', offset_0, offset_1, column_0, column_1, children_1, None)
                children_0.append(value_0)
                offset_0 = offset_1
                column_0 = column_1
        ...
        def parse_object_literal(self, buf, buf_start, buf_eof, offset_0, column_0, indent_column_0, prefix_0, children_0, partial_tab_offset_0, partial_tab_width_0):
            while True: # note: return at end of loop
                ...
                if offset_1 == -1:
                    offset_0 = -1
                    break
                value_0 = self.Node('object', offset_0, offset_1, column_0, column_1, children_1, None)
                children_0.append(value_0)
                offset_0 = offset_1
                column_0 = column_1
                ...
                while True:
                    ...
                    while True: # start capture
                        ...
                        if offset_2 == -1:
                            offset_1 = -1
                            break
                        value_0 = self.Node('pair', offset_1, offset_2, column_1, column_2, children_2, None)
                        children_1.append(value_0)
                        offset_1 = offset_2
                        column_1 = column_2
                        ...
                        while True:
                            ...
                            while True:
                                ...
                                while True: # start capture
                                    ...
                                    children_3.append(self.Node('value', offset_3, offset_3, column_3, column_3, (), 'a'))
